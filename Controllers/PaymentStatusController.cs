...
namespace Leif_Gym_Manager.Controllers
{
    public class PaymentStatusController : Controller
    {
        ...
        public PaymentStatusController(LeifGymManagerMdfContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.PaymentStatuses != null ? 
                          ...
                          Problem("Entity set 'LeifGymManagerMdfContext.PaymentStatuses'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("PaymentStatusId,PaymentStatus1,IsActive,CreatedAt,UpdatedAt")] PaymentStatuss paymentStatus)
        {
            if (ModelState.IsValid)
            {
                paymentStatus.CreatedAt = DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentStatusId,PaymentStatus1,IsActive,CreatedAt,UpdatedAt")] PaymentStatuss paymentStatus)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LeifGymManagerMdfContext.PaymentStatuses'  is null.");
            }
            var paymentStatus = await _context.PaymentStatuses.FindAsync(id);
            if (paymentStatus != null)
            {
